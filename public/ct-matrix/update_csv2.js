...
for(let i=1; i<lines.length; i++) {
    ...
    if (row[3] && row[3].includes('Quiz Night')) {
        ...
        // Background
        row[17] = '_backgrounds/quiz.png';
        
        // QRs
        row[13] = 'https://ctmatrix.com/quiz';
        row[14] = 'https://ctmatrix.com/quiz-footer';
        
        // Set duration test for quiz slides? Let's give them a duration of 15 seconds to test
        row[16] = '15';
    }
...
console.log('CSV updated correctly');
