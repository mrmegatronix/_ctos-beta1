    ...
    <div className="flex-1 p-8 overflow-auto custom-scrollbar bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 shadow-sm ">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
         {suppliers.map(supplier => (
           <div key={supplier.id} className="bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 shadow-sm  rounded-xl border border-gray-200 dark:border-slate-700  p-6 shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden group">
             ...
             <div className="space-y-3">
                ...
                {supplier.website && (
                    <div className="flex items-center text-sm text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 shadow-sm /50 p-2 rounded-lg cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors">
