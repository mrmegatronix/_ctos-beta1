      ...
      <div className="bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-4 mb-6 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-slate-950 text-white border border-white/10 rounded-xl text-xs text-slate-100 outline-none focus:ring-2 focus:ring-purple-500"
          />
        </div>
          ...
          return (
            ...
            >
              <div>
                ...
                {event.performerName && (
                  <div className="mb-4 p-3 bg-slate-950 text-white/60 rounded-2xl border border-slate-100 dark:border-slate-700 flex justify-between items-center text-xs">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-700 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="p-2 text-slate-500 hover:text-purple-600 dark:hover:text-purple-400 rounded-xl hover:bg-white/10 transition-colors transition-colors"
                    title="Edit Event"
                  >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-950 text-white border border-white/10 rounded-xl text-sm font-semibold text-slate-100 outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-slate-950 text-white border border-white/10 rounded-xl text-xs font-semibold text-slate-100 outline-none focus:ring-2 focus:ring-purple-500"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 bg-slate-950 text-white border border-white/10 rounded-xl text-xs text-slate-100 outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-slate-950 text-white border border-white/10 rounded-xl text-xs text-slate-100 outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
