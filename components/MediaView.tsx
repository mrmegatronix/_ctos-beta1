  ...
  return (
    <div className="flex h-full flex-col p-6 space-y-6 bg-slate-50 dark:bg-slate-900/50 overflow-y-auto">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Adverts & Media</h2>
          <p className="text-sm text-gray-500">Control all venue screens and outdoor billboards</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
            ...
            <div className="space-y-2">
              {slides.map(slide => (
                <button
                  ...
                  className={`w-full flex items-center justify-between p-3 rounded-lg transition-all ${activeSlide?.id === slide.id ? 'bg-indigo-50 dark:bg-indigo-900/30 ring-1 ring-indigo-200 dark:ring-indigo-800' : 'hover:bg-gray-50 dark:hover:bg-slate-700/50'}`}
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      <div className="text-sm font-bold text-gray-800 dark:text-gray-100">{slide.name}</div>
        ...
        <div className="lg:col-span-2">
          {activeSlide ? (
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-slate-700 overflow-hidden flex flex-col h-[600px]">
              <div className="p-4 border-b border-gray-100 dark:border-slate-700 flex justify-between items-center bg-gray-50 dark:bg-slate-800/80">
                <div className="flex items-center space-x-3">
                  <span className="text-sm font-bold text-gray-700 dark:text-gray-200">{activeSlide.name}</span>
                  {activeSlide.isDemo && <span className="text-[10px] bg-lime-300 text-lime-900 px-1.5 py-0.5 rounded font-black">DEMO</span>}
                </div>
                <div className="flex items-center space-x-2">
                  <button className="p-2 hover:bg-gray-200 dark:hover:bg-slate-700 rounded-lg text-gray-500 transition-colors">
                    <Settings className="w-4 h-4" />
                  </button>
                  <a href={activeSlide.url} target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-gray-200 dark:hover:bg-slate-700 rounded-lg text-gray-500 transition-colors">
              ...
              <div className="p-4 bg-gray-50 dark:bg-slate-800 border-t border-gray-100 dark:border-slate-700">
                <div className="flex items-center justify-between text-xs">
                  <div className="flex space-x-4">
                    <span className="text-gray-500">Source: <span className="font-mono text-indigo-500">{activeSlide.url}</span></span>
                    <span className="text-gray-500">Transition: <span className="text-gray-700 dark:text-gray-300">Fade (5s)</span></span>
                  </div>
                  <div className="flex items-center space-x-2">
            ...
            <div className="h-full flex items-center justify-center border-2 border-dashed border-gray-200 dark:border-slate-800 rounded-xl">
