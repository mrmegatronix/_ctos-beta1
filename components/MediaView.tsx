    ...
    <div className="flex h-full flex-col p-6 space-y-6 glass-panel /50 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="glass-panel  p-4 rounded-xl shadow-lg border border-gray-100 ">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-2 rounded-lg hover:glass-panel dark:hover:bg-slate-700/50 transition-colors">
            ...
            <div className="space-y-2">
              {slides.map(slide => (
                <button
                  ...
                  className={`w-full flex items-center justify-between p-3 rounded-lg transition-all ${activeSlide?.id === slide.id ? 'bg-indigo-50 dark:bg-indigo-900/30 ring-1 ring-indigo-200 dark:ring-indigo-800' : 'hover:glass-panel dark:hover:bg-slate-700/50'}`}
                >
                  <div className="flex items-center space-x-3">
        ...
        <div className="lg:col-span-2">
          {activeSlide ? (
            <div className="glass-panel  rounded-xl shadow-lg border border-gray-100  overflow-hidden flex flex-col h-[600px]">
              <div className="p-4 border-b border-gray-100  flex justify-between items-center glass-panel /80">
                <div className="flex items-center space-x-3">
              ...
              <div className="p-4 glass-panel  border-t border-gray-100 ">
