...
const BrowserView: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gray-100 dark:bg-slate-900 overflow-hidden">
      {/* Browser Toolbar */}
      <div className="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 p-2 flex items-center space-x-2 shrink-0">
         ...
         <form onSubmit={handleNavigate} className="flex-1 ml-2">
            <div className="flex items-center bg-gray-100 dark:bg-slate-900 rounded-lg px-4 py-2">
               <Globe className="w-4 h-4 text-gray-400 mr-2" />
               <input 
                  type="text" 
                  value={inputUrl}
                  onChange={(e) => setInputUrl(e.target.value)}
                  className="bg-transparent border-none outline-none w-full text-sm text-gray-600 dark:text-gray-300"
