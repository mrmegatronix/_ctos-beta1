  ...
  return (
    <div className="flex-1 p-8 overflow-auto custom-scrollbar bg-white dark:bg-slate-900">
      <div className="mb-8 flex justify-between items-center">
         <div>
             <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Maintenance Log</h2>
             <p className="text-gray-500 dark:text-gray-400">Track repairs and equipment services.</p>
         </div>
        ...
        <section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                {pendingTasks.map(task => (
                    <div key={task.id} className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl p-5 shadow-sm hover:shadow-md transition-all">
                ...
                {pendingTasks.length === 0 && (
                    <div className="col-span-full p-8 text-center bg-gray-50 dark:bg-slate-800/50 rounded-xl border border-dashed border-gray-300 dark:border-slate-700">
                        <p className="text-gray-500 dark:text-gray-400">No active maintenance issues. Good job!</p>
                    </div>
                )}
            </div>
        </section>
