    ...
    <div className="flex-1 p-8 overflow-auto custom-scrollbar bg-slate-900/60 backdrop-blur-xl border-white/10 shadow-sm ">
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
           <div className="bg-slate-900/60 backdrop-blur-xl border-white/10 shadow-sm  p-6 rounded-xl border border-white/10  shadow-lg">
               ...
               <div className="flex items-end mb-2">
                   <span className="text-3xl font-bold text-slate-50  mr-2">
                       $<input type="number" value={budget.targetRevenue} onChange={e => setBudget({...budget, targetRevenue: parseFloat(e.target.value) || 0})} className="bg-transparent border-b border-white/10  w-32 focus:outline-none focus:border-indigo-500" />
                   </span>
               </div>
           ...
           <div className="bg-slate-900/60 backdrop-blur-xl border-white/10 shadow-sm  p-6 rounded-xl border border-white/10  shadow-lg">
               ...
               <div className="flex items-end mb-2">
                   <span className="text-3xl font-bold text-slate-50  mr-2">
                       $<input type="number" value={budget.targetCogs} onChange={e => setBudget({...budget, targetCogs: parseFloat(e.target.value) || 0})} className="bg-transparent border-b border-white/10  w-32 focus:outline-none focus:border-rose-500" />
                   </span>
               </div>
           ...
           <div className="bg-slate-900/60 backdrop-blur-xl border-white/10 shadow-sm  p-6 rounded-xl border border-white/10  shadow-lg">
               ...
               <div className="flex items-end mb-2">
                   <span className="text-3xl font-bold text-slate-50  mr-2">
                       $<input type="number" value={budget.targetLabour} onChange={e => setBudget({...budget, targetLabour: parseFloat(e.target.value) || 0})} className="bg-transparent border-b border-white/10  w-32 focus:outline-none focus:border-blue-500" />
                   </span>
               </div>
       ...
       <div className="bg-slate-900/60 backdrop-blur-xl border-white/10 shadow-sm  rounded-xl border border-white/10  p-6 shadow-lg">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                  ...
                  <input type="number" value={budget.actualRevenue} onChange={e => setBudget({...budget, actualRevenue: parseFloat(e.target.value) || 0})} className="w-full px-3 py-2 border border-white/10  rounded-lg bg-slate-900/60 backdrop-blur-xl border-white/10 shadow-sm  text-slate-50 " />
              </div>
              <div>
                  <label className="block text-sm font-medium text-slate-200  mb-1">Actual COGS</label>
                  <input type="number" value={budget.actualCogs} onChange={e => setBudget({...budget, actualCogs: parseFloat(e.target.value) || 0})} className="w-full px-3 py-2 border border-white/10  rounded-lg bg-slate-900/60 backdrop-blur-xl border-white/10 shadow-sm  text-slate-50 " />
              </div>
              <div>
                  <label className="block text-sm font-medium text-slate-200  mb-1">Actual Labour</label>
                  <input type="number" value={budget.actualLabour} onChange={e => setBudget({...budget, actualLabour: parseFloat(e.target.value) || 0})} className="w-full px-3 py-2 border border-white/10  rounded-lg bg-slate-900/60 backdrop-blur-xl border-white/10 shadow-sm  text-slate-50 " />
              </div>
           </div>
       </div>
    </div>
