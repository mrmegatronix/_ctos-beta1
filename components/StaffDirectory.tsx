  ...
  return (
    <div className="flex-1 p-8 overflow-auto custom-scrollbar glass-panel ">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
         {staff.map(member => (
           <div key={member.id} className={`glass-panel  rounded-xl border border-white/10  p-6 flex flex-col items-center text-center shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden group ${member.isDemo ? 'demo-highlight' : ''}`}>
