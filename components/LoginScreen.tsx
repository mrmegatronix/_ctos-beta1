    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        <div className="p-8 bg-indigo-600 text-center">
           <div className="w-16 h-16 bg-black rounded-full mx-auto mb-4 border-2 border-amber-500 flex items-center justify-center">
             <img src="https://placehold.co/400x400/000000/D4AF37?text=CT" alt="Logo" className="w-full h-full object-cover rounded-full" />
           </div>
           <h1 className="text-2xl font-bold text-white">Coasters Tavern</h1>
           <p className="text-indigo-200 text-sm">Staff Access</p>
        </div>
           ...
           <div className="grid grid-cols-3 gap-4 w-full max-w-xs">
              {[1,2,3,4,5,6,7,8,9].map(n => (
                  <button 
                    ...
                    className="h-16 rounded-xl bg-gray-100 dark:bg-slate-700 text-2xl font-bold text-gray-800 dark:text-white hover:bg-indigo-100 dark:hover:bg-slate-600 active:scale-95 transition-all"
                  >
                    {n}
                  </button>
              ))}
              <div className="col-start-2">
                 <button 
                    onClick={() => handleNum('0')}
                    className="w-full h-16 rounded-xl bg-gray-100 dark:bg-slate-700 text-2xl font-bold text-gray-800 dark:text-white hover:bg-indigo-100 dark:hover:bg-slate-600 active:scale-95 transition-all"
                  >
                    0
                  </button>
              </div>
              <div>
                  <button 
                    ...
                    className="w-full h-16 rounded-xl bg-rose-100 dark:bg-rose-900/30 text-rose-600 flex items-center justify-center hover:bg-rose-200 active:scale-95 transition-all"
                  >
