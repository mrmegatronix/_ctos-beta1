...
import { ClipboardList, Search, CheckCircle, AlertTriangle, Play, Save, Smartphone, X } from 'lucide-react';
      ...
      <div className="p-4 md:p-6 overflow-y-auto">
        <div className="relative max-w-md mb-6">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 shadow-sm text-slate-900 dark:text-slate-50 focus:ring-2 focus:ring-indigo-500 outline-none"
          />
        </div>
